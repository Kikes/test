...
BEGIN
 ...
 ELSE
      ...
      IF V_REM_JOB_ID = 'SA_MAN' THEN
        DBMS_OUTPUT.PUT_LINE('SA_MAN');  
      ELSIF V_REM_JOB_ID = 'IT_PROG' THEN
        DBMS_OUTPUT.PUT_LINE('IT_PROG');
      ELSE
        DBMS_OUTPUT.PUT_LINE('OTHER JOB_ID');
      END IF;
    /*SELECT 
